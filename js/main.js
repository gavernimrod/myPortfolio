...
function sendForm(){
    ...
    var text = $('#text').val();
    // var url =`https://mail.google.com/mail/?view=cm&fs=1&to=gavernimrod@gmail.com&su=${subject}SUBJECT&body=${text}`;
    submitEmail(subject,text)
}

function submitEmail($subject,$msg) {
    window.open('https://mail.google.com/mail/?view=cm&fs=1&to=gavernimrod@gmail.com&su='+ $subject +'&body='+ $msg +'', '_blank');
}
